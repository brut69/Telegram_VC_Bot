HELP_TEXT = """__**I Can Play Music In The Voice Chat Secret**__
...
**/queue play format/nothing** __Shows Queue List. If you send plformat with command you will get it in playlist format.__
**/delqueue** __Deletes Queue List and Playlist.__
**/playlist** __Start Playing Playlist.__
"""

REPO_TEXT = (
    "[Source](https://github.com/thehamkercat/Telegram_vc_bot)"
    "[Github](https://github.com/brut69/Telegram_vc_bot)"
    + " | [Group](t.me/fantaestheticgang)"
)
